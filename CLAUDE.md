...
- `mey-standards` — Apply Mey coding standards for any task that creates, edits, reviews, or refactors PHP or Blade code; covers strict typing, action classes, Eloquent models, controllers, Livewire components, and Blade view structure.
